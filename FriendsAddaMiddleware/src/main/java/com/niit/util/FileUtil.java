...
public class FileUtil {
	...
	private static final String ABS_PATH = "C:/Users/bhano/project 2/SPA/WebContent/assets/images/User_ProfilePic/";
	private static String REAL_PATH = null;
	private static final Logger logger = LoggerFactory.getLogger(FileUtil.class);
	public static boolean uploadFile(HttpServletRequest request, MultipartFile file, String code) 
	{				
		// get the real server path
		//REAL_PATH = request.getSession().getServletContext().getRealPath("/assets/images/User_ProfilePic/");
