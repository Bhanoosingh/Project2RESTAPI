...
public class FriendController {
	...
	public ResponseEntity<List<Friend>> showAllFriends(HttpSession session)
	{
		...
		List<Friend> listAllFriends=friendDAO.showAllFriends("bhanoosinghpacex1@gmail.com");
	...
	{
		//String loginname=((UserDetail)session.getAttribute(("userdetail"))).getLoginname();
		List<Friend> listPendingRequests=friendDAO.showRequestPendingList("Bhanoo");
